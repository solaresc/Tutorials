...
public class HibernateHelper 
{
    ...
    static protected Logger log = Logger.getLogger("bytesizebook.webdev.hibernate");
    ...
    static protected SessionFactory buildFactory(Configuration cfg) throws Exception 
    {
        SessionFactory factory = null;
        try 
        {
    ...
    static public java.util.List getListData(Class classBean, String strKey, Object value) 
    {
    ...
    static public java.util.List getListData(Class classBean, String strKey1, Object value1, String strKey2, Object value2) 
    {
        java.util.List result = new java.util.ArrayList();
